...
//
//        query.getInBackground(mEmailView.toString(), new GetCallback<ParseObject>() {
...
//            ParseUser.logInInBackground("lucas@gmail.com", "jaqueline", new LogInCallback() {
                  public void done(ParseUser user, ParseException e) {
                    if (user != null) {
                        ...
                        //Registrando um novo usuário - salvando no banco
                        ParseUser pUser = new ParseUser();

                        pUser.setUsername(mEmailView.getText().toString());
                        pUser.setPassword(mPasswordView.getText().toString());
                        pUser.setEmail(mEmailView.getText().toString());

                        pUser.signUpInBackground(new SignUpCallback() {
                            public void done(ParseException e) {
                                if (e == null) {
                                    Context context = getApplicationContext();
                                    CharSequence text = "Seja bem vindo ao Task App!";
